...
@section('content')
    ...
    <div id="showcr">
	    <div class="col-sm-offset-4 col-sm-4">
	    	<br>
	    	<div class="panel-heading">Modifier un compte-rendu</div>
			<div class="panel panel-primary">
				...
				<div class="panel-body"> 
                    ...
                    <div class="col-sm-12">
                    {!! Form::model($joueurs, ['route' => ['joueur.update', '$joueurs->id_compterendu == $compterendu->id'], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}   
                        <div class="form-group">
                            <table id="mydiv">                            
                                <thead>
                                    <tr>
